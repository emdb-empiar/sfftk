...
class segmentation(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='segmentation'):
        if self.schemaVersion != "0.6.0a4" and 'schemaVersion' not in already_processed:
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from v_0_6_0_a_4 import *\n\n')
        sys.stdout.write('import v_0_6_0_a_4 as model_\n\n')
