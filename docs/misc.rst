...
multiple such masks are use to represent multiple segments, the volume of data is unnecessarily large leading to the
need to merge the masks into a multi-labelled mask.
